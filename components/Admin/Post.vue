<template>
  <client-only>
    <v-container fluid>
      ...
      <v-data-table :headers="headers" :items="content" single-expand :expanded.sync="expanded" item-key="name" show-expand class="elevation-5 mt-5" :page.sync="page" :search="search" :items-per-page="itemsPerPage" @page-count="pageCount = $event" hide-default-footer>
