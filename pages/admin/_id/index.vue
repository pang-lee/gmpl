...
import Live from '~/components/Admin/Live.vue'
...
export default class User extends Vue {
  ...
  change_content(index){
    switch(index){
      ...
      break
      case 1: return this.current = 'Live'
      break
      case 2: return this.current = 'Friend'
      break
      case 3: return this.current = 'Post'
      break
      case 4: return this.current = 'Analysis'
      break
